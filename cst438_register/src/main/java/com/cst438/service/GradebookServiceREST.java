...
public class GradebookServiceREST extends GradebookService {
	...
	public void enrollStudent(String student_email, String student_name, int course_id) {
		...
		System.out.println("posted to gradebook: "+ enrollment);
		EnrollmentDTO respond = restTemplate.postForObject(gradebook_url+"/enrollment", enrollment, EnrollmentDTO.class);
		System.out.println("Respondse from greadbook"+respond);
	}
